...
async function seed() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        imageUrl: [`${faker.image.imageUrl()}`, `${faker.image.imageUrl()}`, `${faker.image.imageUrl()}`],
        diet: [`${faker.commerce.productAdjective()}`, `${faker.commerce.productAdjective()}`, `${faker.commerce.productAdjective()}`],
        ...
        listOfBusinesses: [`${faker.company.bsNoun()}`, `${faker.company.bsNoun()}`, `${faker.company.bsNoun()}`],
